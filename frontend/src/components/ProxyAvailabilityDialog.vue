  ...
  >
    <v-card>
      <v-card-title class="tw-flex">
        <div>Who is this availability for?</div>
        <v-spacer />
      ...
      <v-card-text>
        ...
        >
          <v-text-field
            ...
            hint="They don't need an account. Only you can add or edit this response."
            persistent-hint
            autofocus
            autocomplete="off"
            solo
          ...
          <v-text-field
            ...
            hint="This event collects emails. It will only be visible to you."
            persistent-hint
            solo
          ></v-text-field>
          <div class="tw-flex">
...
export default {
  ...
  methods: {
    submit() {
      // Set rules only on submit so the form doesn't error before it's filled in
      this.nameRules = [
